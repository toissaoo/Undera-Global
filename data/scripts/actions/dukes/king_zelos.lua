local config = {
	requiredLevel = 250,
	dailtrue,
	roomCenterPosition = Position{33443, 31542, 13},
	playerPositions = {
	...
	teleportPosition = Position{33443, 31553, 13},
	bossPosition = Position{33443, 31542, 13}
}
	...
	if item.itemid == 9825 then
		...
		for i = 1, #config.playerPositions do
			...
			if participant and participant:isPlayer() then
				...
				if config.daily and participant:getStorageValue(Storage.GraveDanger.KingZelos) > os.time() then
