local setting = {
	centerRoom = {x = 33456, y = 31478, z = 13},
	storage = Storage.GraveDanger.Dukes.Krule,
	bossPosition = {x = 33456, y = 31477, z = 13},
	kickPosition = {x = 33456, y = 31498, z = 13},
	playerTeleport = {x = 33456, y = 31478, z = 13}
}

local kruleLever = Action()

-- Start Script
function kruleLever.onUse(creature, item, fromPosition, target, toPosition, isHotkey)
	if item.itemid == 9825 and item.actionid == 20004 then
