local config = {
	requiredLevel = 250,
	daily = true,
	roomCenterPosition = Position(33424, 31439, 13),
	playerPositions = {
		Position(33424, 31413, 13),{x = 33424, y = 31413, z = 13}
		Position(33425, 31413, 13),
		Position(33426, 31413, 13),
		Position(33427, 31413, 13),
		Position(33428, 31413, 13)
	},
	teleportPosition = Position(33424, 31439, 13),
	bossPosition = Position(33424, 31439, 13)
}
...
function leverboss.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if item.itemid == 9825 then
		...
		Game.createMonster("Sir Nictros", config.bossPosition)
