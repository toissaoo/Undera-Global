local config = {
	[4604] = {
		...
		bossPos = Position{33509, 31493, 9}
	}
}

local VokEntrance = MoveEvent()

function VokEntrance.onStepIn(creature, item, position, fromPosition)
...
VokEntrance:type("stepin")
VokEntrance:aid(4604)
VokEntrance:register()
